...
var reviewFormHandler = function reviewFormHandler() {
  btnsReview.forEach(function (btn) {
    return btn.addEventListener('click', openReviewForm);
  });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11893" + '/');
